...
$a  =$_FILES["file"]["name"];
mysql_query("update profile set dfimg='$a' where userid='".$_SESSION['user']."'");
}
    ...
    <div class="header">
      ...
      <div class="search">
         <form name="searchcode"method="post" action="searchcode.php"  >
          <span>
          <input type="text"  name="searchprofile2" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="me">
          ...
          <span style="color:green;">Edit Profile pic</span>
          <img src="<?php echo "images/".$image['dfimg'];  ?>" width="120"height="120" >
          <input type="file" name="file"><br>
          <input type="submit" name="sub2" value="done">
           </form></div>
         
      <div class="hbg">
          
         <div class="tab">
                 <form  method="post" action="profilecode.php">
           <center> <label id="heading" >Edit Information</label></center><br><br><br>
         <table align="center" cellspacing="15" >
            <tr><td class="t"><b>Basic Info</b></td></tr>
             <tr ><td>Work</td><td ><input  type="text"size="25" name="work"></td></tr>
             <tr><td >Education</td><td><input  type="text"size="25" name="edu"></td></tr>
             <tr><td >Relationship</td><td><input type="text"size="25" name="relationship"></td></tr>
             <tr><td >Religious view</td><td ><input  type="text"size="25" name="rviews"></td></tr>
             
             <tr><td class="t"><b>Contact info</b></td></tr>
             <tr><td >Mobile no.</td><td><input  type="text"size="25" name="mob"></td></tr>
             <tr><td >Email-Id</td><td ><input  type="text"size="25" name="email"></td></tr>
             
             <tr><td class="t"><b>About You</b></td></tr>
             <tr><td >Favourate Quotation</td><td><input  type="text"size="25" name="quote"></td></tr>
             <tr><td  align="center"><input type="submit" name="sub1" value="ok"></td></tr>
                    </table>
                </form>
         </div>
            </div>
