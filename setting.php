    ...
    <div class="header">
      ...
      <div class="search">
        <form name="searchcode"method="post" action="searchcode.php"  >
          <span>
          <input type="text"  name="searchsetting" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg">
           ...
           <center> <label id="heading" >Set Your Account</label></center><br><br><br>
           <table cellspacing="17" align="center">
         <tr class="menu_nav1"><td class="active"><a href="changepasswd.php">Change Password</a></td></tr>
        
        
        <tr class="menu_nav1"><td><a href="deactive.php">Deactive Account</a></td></tr>
