    ...
    <div class="header">
      ...
      <div class="search">
         <form name="searchcode"method="post" action="searchcode.php"  >
          <span>
          <input type="text"  name="searchfrnds" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg"><
          <table cellspacing="12" align="center">
             <th  style="color:#78bbe6;" >Searching</th>
             <tr><td align="center"><a href="friendprofile.php"> <span style="color:#48ACDE;"><?  echo $_SESSION['qur'];?></span></a></td></tr>
             </table>
      </div>
    </div>
    <div class="content">
