...
$qur2 =mysql_query("select * from profile where userid='".$_SESSION['user']."'");
$image=mysql_fetch_array($qur2);
    ...
    <div class="header">
      <div class="logo">
        ...
        <div class="search">
         <form name="searchcode"method="post" action="searchcode.php" >
          <span>
          <input type="text"  name="searchinbox" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg">
             ...
             <div class="tab">
                <form name="msz" method="post" action="delete.php">
            <div id="msz">
            <center> <label id="heading" >Inbox</label></center><br><br><br>
           <?php while($row=mysql_fetch_array($qur1))
            {
           ?>
            <div id="inbox">
         
           &nbsp&nbsp     
           <span style="color:red;"><? echo $row['ufirst'];?></span>
            
           <span style="position:absolute;left:690px;"><? echo $row['sendmsz'];?></span></font>
           <input type=submit value=Delete name="delete"  style="position:absolute;left:950px;">
            </div>
