  ...
  <div class="main_resize">
    <div class="header">
      ...
      <div class="search">
          ...
          <span>
          <input type="text"  name="searchprofile" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg">
         ...
         <div class="tab">
           <center> <label id="heading" >Profile Information &nbsp&nbsp&nbsp<font class="edit"><a href="profile2.php">Edit Profile Info</a></font></label></center><br><br><br>
         <table class="tab1" >
           <?php
           include 'connection.php';
           $qur  =mysql_query("select * from profile where userid='".$_SESSION['user']."'");
            while($row=mysql_fetch_array($qur))
            {
           ?>
            <tr><td class="t"><b>Basic Info</b><td></tr>
            <tr><td><table  cellspacing="13">
                   <tr><td >Work</td><td><span style="margin-left:50px;"><?php echo $row['work']?></span></td></tr>
                   <tr><td>Education</td><td ><span style="margin-left:50px;"><?php echo $row['edu']?></span></td></tr>
                   <tr><td>Relationship</td><td ><span style="margin-left:50px;"><?php echo $row['relationship']?></span></td></tr>
                   <tr><td>Religious views</td><td ><span style="margin-left:50px;"><?php echo $row['rviews']?></span></td></tr>
            ...
            <tr><td><table cellspacing="10">
                    <tr><td>Mobile</td><td ><span style="margin-left:100px;"><?php echo $row['mob']?></span></td></tr>
                    <tr><td>Email Id</td><td ><span style="margin-left:100px;"><?php echo $row['email']?></span></td></tr>
                  </table>
                </td>
            </tr>
            <tr><td><hr ></td></tr>
            ...
            <tr><td><table  cellspacing="10">
            <tr><td>Favourate Quotation</td><td><span style="margin-left:20px;"><?php echo $row['quote']?></span></td></tr>
                    </table>
                </td>
            </tr>
          </table> 
