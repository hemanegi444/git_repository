 ...
 function fieldcheck(field,alerttext)
{
 	...
 	function studentformcheck(thisform)
 {
  with(thisform)
   {
   if((fieldcheck(old1,"enter old password")==false)||
   (fieldcheck(new1,"enter new password")==false))
      return false; 
   } 
 }
...
<body onLoad="document.changepasswd.old.focus();">
    ...
    <div class="header">
      ...
      <div class="search">
         <form name="searchcode"method="post" action="searchcode.php" >
          <span>
          <input type="text"  name="searchchange" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg">
             ...
             <div class="tab">
          <form name="changepasswd" method="post" action="changepasscode.php" onSubmit="return studentformcheck(this)">
         <center> <label id="heading" >Change Password</label></center><br><br><br>
       ...
       <tr><td >new password</td>
        ...
        <tr><td><input type=submit name='sub1' value=Done ></td>    
        
        </table>
           </form >
                 <table>
                   <tr>
                       <td style="position:absolute;top:350px;right:350px;"><a href="setting.php"><input name="back" type="submit" value="Back" width="30" height="30" /></a><td>
                   </tr>
                 </table>
        </div>
            </div>
