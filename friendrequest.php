    ...
    <div class="header">
      ...
      <div class="search">
         <form name="searchcode"method="post"  action="searchcode.php">
          <span>
          <input type="text"  name="searchfreq" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg">
             ...
             <div class="tab">
           <form name="msz" method="post" action="accept.php">
           <center> <label id="heading" >Friend Request</label></center><br><br><br>
           <?php while($row2=mysql_fetch_array($qur2))
            {
           ?>
            <div id="FriendRequest">
              
          <span style="color:red;">&nbsp;&nbsp;<? echo $row2['sFirst'];?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         want to be your friend &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           <input type=submit value=accept name="accept" style="position:absolute;right:120px;" >
            </div>
