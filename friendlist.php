...
$qur2=mysql_query("select * from accept where sId='".$_SESSION['user']."' ");

$qur3  =mysql_query("select * from profile where userid='".$_SESSION['user']."'");
$image=mysql_fetch_array($qur3);
...
<div class="main">
  <div class="main_resize">
    ...
    <form name="searchcode"method="post" action="searchcode.php"  >
          <span>
          <input type="text"  name="searchfrndlist" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg">
           ...
           <center> <label id="heading">Friend List</label></center><br><br><br>
         
          <?php while($row2=mysql_fetch_array($qur2))
            {
              
           ?>
           <div id="FriendList">
             &nbsp&nbsp   
           <span style="color:red;"><? echo $row2['uFirst']; ?></span>
           
          <input type="submit" value="unfriend" name="unfriend2" style="position:absolute;right:120px;">
           </div>
           <?php }?>
            
             
            
            <?php while($row1=mysql_fetch_array($qur1))
            {
           ?>
            <div id="UnFriend">
         
           &nbsp&nbsp     
           <span style="color:red;"><? echo $row1['sFirst']; ?></span>
           
     
           <input type="submit" value="unfriend" name="unfriend" style="position:absolute;right:120px;"></div>
            <?php }?>
           </form>
        </div>
            </div>
