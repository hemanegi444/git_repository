...
function chkradio()
{
var elem=document.forms['radioform'].elements['account'];
len=elem.length-1;
chkvalue='';
for(i=0; i<=len; i++)
{
  ...
  <div class="main_resize">
    <div class="header">
      ...
      <div class="search">
          ...
          <span>
          <input type="text"  name="searchdyes" id="s" />
     <input name="searchsubmit" type="image" src="images/search.gif" id="searchsubmit" class="btn"  />
      ...
      <div class="hbg">
             ...
             <div class="tab">
           <form name="radioform" method="post"   action="dcode.php" onsubmit="chkradio()">
           <center> <label id="heading" > Account Deactivate ?</label></center><br><br><br>
           <table cellspacing="17" align="center">
        <tr><td ><input type="radio" name="account" value="Its temporary,I'll be back">Its temporary,I'll be back</td> </tr>
        <tr><td ><input type="radio" name="account" value="Its permanently">Its permanently</td> </tr>
...
<tr><td><input type=submit name='sub1' value=Done ></td></tr>
                  ...
                  <table>
                   <tr>
                       <td style="position:absolute;top:344px;right:330px;"><a href="setting.php"><input name="back" type="submit" value="Back" width="30" height="30" /></a><td>
                   </tr>
                 </table>
        </div>
            </div>
