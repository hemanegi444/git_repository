...
<script language="javascript">
    ...
    function fun()
    {
        ...
        if(document.frm.userid.value==""){
            document.getElementById("name1").innerHTML="name should not empty";
...
<div class="main">
  <div class="header">
   ...
   {$a=$_SESSION['err']; echo $a; unset($_SESSION['err']);}    ?></span></td></tr>
                 ...
                 <tr><td class="nn"  ><a href ="fpass.php">Forget Password...</a></li></td></tr>
                 <tr><td  class="nn" ><a href ="reg.php">Create an Account??</a></td></tr>
                 <tr><td  class="nn" ><a href ="comeback.php">Come back?</a></td></tr>      
                </td></tr>
                </table></td>
            </tr>
            </table>
